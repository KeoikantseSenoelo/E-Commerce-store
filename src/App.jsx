...
const App = () => {
  ...
  const isMobile = useIsMobile(); // Use custom hook for detecting mobile
  ...
  // Hide sidebar on certain paths for large screens, but show on mobile
  const shouldHideSidebar = isMobile || ["/checkout", "/add-payment", "/add-address"].includes(location.pathname);
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1">
        {/* Sidebar should be visible on both mobile and larger screens for Product-related pages */}
        <Sidebar />
        ...
        {/* Bag component or BagSidebar for Desktop view */}
