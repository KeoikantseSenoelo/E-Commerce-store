...
import { Routes, Route, useLocation } from "react-router-dom"; // Router setup
  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="flex flex-1">
        ...
        <main className={`flex-1 p-4 bg-gray-100 ${shouldHideSidebar ? "w-full" : ""}`}>
          <Routes>
            ...
            <Route
              path="/Product"
              element={
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 ml-[58px]">
        ...
        {/* Sidebar containing Bag Sidebar or regular Bag component */}
        {!shouldHideSidebar && (
